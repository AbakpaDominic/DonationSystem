...
$config['paystack.secret_key'] = $_ENV['PAYSTACK_SECRET_KEY'];
//$config['paystack.secret_key'] = $_ENV['PAYSTACK_PUBLIC_KEY'];
...
$config['smtp.settings']['smtp_protocol'] = 'smtp';
 ...
 * If you make changes to this file, be sure to protect  again after making
